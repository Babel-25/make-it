            ...
            <div class="form-panel">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form class="form-horizontal style-form" method="POST" action="{{ route('sexes.store') }}"
                            id="form_user">
                            @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <form class="form-horizontal style-form" method="POST" action="{{ route('etats.store') }}"
                            id="form_auth">
                            @csrf
                            <div class="form-group">
                                <div class="col-sm-10">
                                    ...
                                    <select name="codeEtat" placeholder="Code" class="form-control mb-3" required>
                                        <option value=""> </option>
                            ...
                            <tbody>
                                @foreach ($sexes as $sexe)
                                    <tr>
                                        ...
                                        <td> {{ $sexe->libelle }} </td>
                                        <td align="center">
                                            <a href="{{ route('edit_sexe', $sexe->id) }}" title="">
                                                <button class="btn btn-primary btn-circle"><i class="fa fa-pencil-square-o"
                                                        aria-hidden="true"></i>Modifier</button> </a>
                                            <form method="POST" action="{{ url('/Configuration' . '/' . $sexe->id) }}"
