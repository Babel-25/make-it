...
@section('content')
    <section class="mt container">
        ...
        <div id="DeuxFieuls" class="mt">
            <div class="row">
                <div class="col-md-4" style="border-color: green;border-style:solid;height:3em"> </div>
                <div class="col-md-4 col-md-offset-4" style="border-color: green;border-style:solid;height:3em">
                </div>
            </div>
        </div>
